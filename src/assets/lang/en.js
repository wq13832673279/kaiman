module.exports = {
  ...
  service: {
    ...
    description: {
        ...
        message3: 'Cayman Exchange supports 10,000 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'Cayman Exchange Cayman Mobile Office Mobile Client Focused on Handheld Trading Experience',
    },
    footer: {
